...
def sendMessage()
    ...
    $browser.div(class: "msg-form__contenteditable", index: 0).send_keys("Hi, Fritz! If you're reading this, odds are my script worked! I'd love to hear your feedback as well as maybe collaborate on some future projects together. Hit me up on Calendly and let's find a time to catch up!\n(https://calendly.com/ezra-rabinsky/code-challenge-follow-up)")
